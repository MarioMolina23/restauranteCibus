...
import 'agregar_ingrediente_paso2_widget.dart'
    show AgregarIngredientePaso2Widget;
...
class AgregarIngredientePaso2Model
    extends FlutterFlowModel<AgregarIngredientePaso2Widget> {
  ...
  // Stores action output result for [Custom Action - subtractIngredientsFromProduct] action in Button widget.
