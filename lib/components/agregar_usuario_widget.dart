...
import 'agregar_usuario_model.dart';
export 'agregar_usuario_model.dart';

class AgregarUsuarioWidget extends StatefulWidget {
  const AgregarUsuarioWidget({Key? key}) : super(key: key);

  @override
  _AgregarUsuarioWidgetState createState() => _AgregarUsuarioWidgetState();
}

class _AgregarUsuarioWidgetState extends State<AgregarUsuarioWidget>
    with TickerProviderStateMixin {
  late AgregarUsuarioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AgregarUsuarioModel());
    ...
    _model.txtSalarioController ??= TextEditingController();
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 12.0),
                                  child: TextFormField(
                                    controller: _model.txtNumeroController,
                                    ...
                                    validator: _model
                                        ...
                                        .asValidator(context),
                                    inputFormatters: [_model.txtNumeroMask],
                                  ),
                                ),
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 12.0),
                                  child: TextFormField(
                                    controller: _model.txtSalarioController,
                                ...
                                FlutterFlowDropDown<String>(
                                  controller: _model.txtRolValueController ??=
                                  ...
                                  onChanged: (val) =>
                                      setState(() => _model.txtRolValue = val),
                                  width: 700.0,
                                  height: 50.0,
                                  textStyle:
                                                  ...
                                                  : () async {
                                                      ...
                                                      if (confirmDialogResponse) {
                                                        await actions
                                                          ...
                                                          'https://pinpj.com.mx/wp-content/uploads/2020/11/portada-colores.jpg',
                                                          _model
