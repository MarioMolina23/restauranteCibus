...
class _EditarPerfilWidgetState extends State<EditarPerfilWidget>
  ...
  void initState() {
    ...
    _model.txtTelefonoController1 ??=
        TextEditingController(text: widget.usuario?.phoneNumber);
    _model.txtTelefonoFocusNode1 ??= FocusNode();

    _model.txtTelefonoController2 ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.role, ''));
    _model.txtTelefonoFocusNode2 ??= FocusNode();
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          TextFormField(
                                            ...
                                            validator: _model
                                                .txtTelefonoController1Validator
                                                .asValidator(context),
                                            inputFormatters: [
                                              _model.txtTelefonoMask1
                                            ],
                                          ),
                                        ],
                                      ),
                                        ...
                                        children: [
                                          AuthUserStreamWidget(
                                            builder: (context) => TextFormField(
                                              controller:
                                                  _model.txtTelefonoController2,
                                              focusNode:
                                                  _model.txtTelefonoFocusNode2,
                                              readOnly: true,
                                              obscureText: false,
                                              decoration: InputDecoration(
                                                labelStyle:
                                              ...
                                              keyboardType: TextInputType.phone,
                                              validator: _model
                                                  .txtTelefonoController2Validator
                                                  .asValidator(context),
                                              inputFormatters: [
                                                _model.txtTelefonoMask2
                                              ],
                                            ),
                                          ),
                                        ],
