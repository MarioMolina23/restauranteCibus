...
import 'editar_platillo_model.dart';
export 'editar_platillo_model.dart';

class EditarPlatilloWidget extends StatefulWidget {
  const EditarPlatilloWidget({
    Key? key,
    required this.platillo,
  }) : super(key: key);

  final MenuRecord? platillo;

  @override
  _EditarPlatilloWidgetState createState() => _EditarPlatilloWidgetState();
}

class _EditarPlatilloWidgetState extends State<EditarPlatilloWidget>
    with TickerProviderStateMixin {
  late EditarPlatilloModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarPlatilloModel());

    _model.txtNombreController ??=
        TextEditingController(text: widget.platillo?.dishName);
    _model.txtNombreFocusNode ??= FocusNode();

    _model.txtPrecioController ??= TextEditingController(
        text: formatNumber(
      widget.platillo?.price,
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            'Selecione nuevas categorias para el platillo',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Poppins',
                                          ...
                                          wrapWithModel(
                                            model:
                                                _model.dishTypesComponentModel,
                                            updateCallback: () =>
                                                setState(() {}),
                                            child: DishTypesComponentWidget(),
                                          ),
                                        ],
                                      ),
                                    ),
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          await widget.platillo!.reference
                                              .update({
