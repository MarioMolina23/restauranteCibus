                                                    ...
                                                    builder:
                                                      ...
                                                      return AlertDialog(
                                                        title: Text(
                                                            'Campo es requerido'),
                                                        content: Text(
                                                            'Seleccione una de las opciones para unidad de medida.'),
                                                        actions: [
                                                          TextButton(
                                                            onPressed: () =>
                                                                Navigator.pop(
