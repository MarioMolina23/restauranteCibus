...
class _EditarUsuarioWidgetState extends State<EditarUsuarioWidget>
  ...
  void initState() {
    ...
    _model.txtTelefonoController ??=
        TextEditingController(text: widget.usuario?.phoneNumber);
    _model.txtTelefonoFocusNode ??= FocusNode();

    _model.txtSalarioController ??=
        TextEditingController(text: widget.usuario?.salary?.toString());
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Align(
                                            ...
                                            child: FlutterFlowDropDown<String>(
                                              controller: _model
                                                      .txtEstadoValueController ??=
                                                  FormFieldController<String>(
                                                _model.txtEstadoValue ??=
                                                    '${() {
                                                  if (widget.usuario?.status ==
                                                      'Activo') {
                                                    return widget
                                                        .usuario?.status;
                                                  } else if (widget
                                          ...
                                          onPressed: () async {
                                            ...
                                            if (confirmDialogResponse) {
                                              ...
                                              await widget.usuario!.reference
                                                ...
                                                role: _model.txtRolValue,
                                                salary: double.tryParse(_model
                                                    .txtSalarioController.text),
                                                status: _model.txtEstadoValue,
                                                photoUrl: FFAppState()
                                                            .imagenEditando !=
                                                        ''
                                                    ? _model.uploadedFileUrl
