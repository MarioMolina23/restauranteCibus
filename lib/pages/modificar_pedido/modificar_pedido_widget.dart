...
import 'modificar_pedido_model.dart';
export 'modificar_pedido_model.dart';

class ModificarPedidoWidget extends StatefulWidget {
  const ModificarPedidoWidget({
    Key? key,
  ...
  @override
  _ModificarPedidoWidgetState createState() => _ModificarPedidoWidgetState();
}

class _ModificarPedidoWidgetState extends State<ModificarPedidoWidget> {
  late ModificarPedidoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModificarPedidoModel());
                                                    ...
                                                    children: [
                                                      StreamBuilder<
                                                        ...
                                                        builder: (context,
                                                          ...
                                                          List<RequestRecord>
                                                              btnAgregarModificarRequestRecordList =
                                                              snapshot.data!;
                          ...
                          singleRecord: true,
                            ...
                            if (_model.columnPreviousSnapshot != null &&
                                !const ListEquality(
                                    ...
                                    .equals(columnRequestRecordList,
                                                ...
                                                child: Container(
                                                  height:
                                                      MediaQuery.sizeOf(context)
                                                          ...
                                                          0.5,
                                                  child:
                                                      DetalleOrdenModificarWidget(
                                                    refOrden: widget.refOrden!,
                                                  ),
                                                ),
                                              ),
                                            );
                              ...
                              Expanded(
                                child: StreamBuilder<List<OrdersRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<OrdersRecord>
                                        priceSummaryOrdersRecordList =
                                        snapshot.data!;
                                    final priceSummaryOrdersRecord =
                                        priceSummaryOrdersRecordList.isNotEmpty
                                            ? priceSummaryOrdersRecordList.first
                                            : null;
                                    return Column(
                                      mainAxisSize: MainAxisSize.max,
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: StreamBuilder<
                                                    ...
                                                    builder:
                                                      ...
                                                      List<RequestRecord>
                                                          txtDescuentoRequestRecordList =
                                                          snapshot.data!;
                                                      return TextFormField(
                                                        controller: _model
                                                                .txtDescuentoController ??=
                                                            TextEditingController(
                                                          text: _model.isLoaded ==
                                                                  false
                                                              ? priceSummaryOrdersRecord
                                                                  ?.percentageDiscount
                                                              : '0',
                                                        ),
                                                        focusNode: _model
                                        ...
                                        Padding(
                                          ...
                                          child: StreamBuilder<
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              List<RequestRecord>
                                                  confirmarModificarRequestRecordList =
                                                  snapshot.data!;
                                              return FFButtonWidget(
                                                onPressed: () async {
                                                  await actions
                                                  ...
                                                  if (_model
                                                    ...
                                                    await HistoryRecord
                                                        ...
                                                        .set(
                                                          ...
                                                          role: valueOrDefault(
                                                              ...
                                                              ''),
                                                          description:
                                                              'Modificó Pedido: Mesa #${widget.numMesaParametro.toString()}',
                                                        ));
                                                    ...
                                                    await NotificationsRecord
                                                        ...
                                                        .set(
                                                          ...
                                                          message:
                                                              '¡Se ha realizado una actualización en el pedido de la mesa #${widget.numMesaParametro?.toString()}!',
                                                          time:
                                                              getCurrentTimestamp,
                                                        ));
                                                    setState(() {
